...
Route::get('/store', 'PortofolioController@index')->name('talents');
Route::get('/porto/{id}', 'PortofolioController@detail')->name('talents-detail');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/dashboard/wds/create', 'WdController@wd')
        ->name('dashboard-wd');
    Route::post('/dashboard/wds', 'WdController@store')
        ->name('dashboard-wd-store');
